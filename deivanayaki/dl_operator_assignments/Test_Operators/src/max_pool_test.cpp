#include "../include/max_pool_test.h"
#include "../../utils/include/FileUtils.h"

void MaxPoolTest :: checkMaxPoolLayerOutput(const std::string& imagePath,const std::string& layerName,const std::vector<std::vector<std::vector<double>>>& feature_map)
{
