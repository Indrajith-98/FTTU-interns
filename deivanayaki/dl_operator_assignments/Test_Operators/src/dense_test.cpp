#include "../include/dense_test.h"
#include "../../utils/include/FileUtils.h"

void DenseTest :: checkDenseLayerOutput(const std::string& imagePath,const std::string& layerName,const std::vector<double>& feature_map)
{
