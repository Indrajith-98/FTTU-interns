#include "../include/flatten_test.h"
#include "../../utils/include/FileUtils.h"

void FlattenTest :: checkFlattenOutput(const std::string& imagePath,const std::string& layerName,const std::vector<double>& feature_map)
{
